    ...
    return (
        <div className=" h-auto w-screen  opacity-100 bg-bg2 scroll-smooth">
            <div className='absolute'>
                <video autoPlay muted loop className='  w-screen opacity-70  object-cover' style={{ height: "80vh" }}>
                    <source src="2.mp4" type="video/mp4" />
                </video>
            </div>
            <div className='relative  '>
                <div>  <ul className='flex justify-around '>
                    <li className='mt-20'>
                        <NavLink className={liStyle}> <button>Photo </button></NavLink>
                    </li>
                    <li className='mt-20'>
                        <NavLink className={liStyle}> <button>Vecteur  </button></NavLink>
                    </li>
                    <li className='mt-20' >
                        <NavLink className={liStyle}> <button> Illustration</button></NavLink>
                    </li>
                </ul></div>
                <div className='mt-20 text-center text-white text-xl'>
                    <h1 className='text-6xl font-bold '>Trouver vos meilleur illustration </h1>
                ...
                <div className='flex justify-center mt-10 '>
                    <BiSearchAlt className='text-3xl relative top-4 left-16 text-gray-400' />
                    <input className='h-16 w-3/4 rounded-full p-4 px-20 placeholder:text-xl shadow-lg outline-none text-xl' placeholder='Recherche...' />
                </div>
            </div>
            <div className='mt-32 m-10 bg-bg2'>
                <div>
